...
if r.status_code != 200:
    print("Status Code: " + str(r.status_code))
    print(r.text)
    sys.exit("Error thrown while creating consumer instance")

print("Base URI: " + r.json()["base_uri"])

print("Subscribin the consumer to the topic hello-python-topic")
...
if r.status_code != 204:
    print("Status Code: " + sttttr(r.status_code))
    print(r.text)
    delete_consumer()
